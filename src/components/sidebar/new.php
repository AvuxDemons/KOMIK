            ...
            <div class="relative flex space-x-3 rounded transition">
                ...
                <div class="min-w-0 flex-1">
                    <div class="flex flex-col focus:outline-none gap-1">
                        <a href="/komik/<?php echo $manga['endpoint']; ?>"
                            class="w-full text-sm font-medium transition hover:text-primary-600 truncate">
                            <p class="overflow-hidden truncate max-w-[250px]">
                                <?php echo $manga['title']; ?>
                            </p>
                        </a>
                        <p
                            class="flex flex-wrap font-medium text-xs gap-[5px] overflow-hidden truncate max-h-[60px] leading-[15px]">
                            Genres:
                            <?php foreach ($manga['genres'] as $genre): ?>
                                <a href="/genre/<?php echo $genre['endpoint']; ?>"
                                    class="text-primary-600 text-[0.75rem] transition hover:text-primary-900">
