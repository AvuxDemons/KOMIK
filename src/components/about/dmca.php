<section>
    <div class="flex justify-between items-center mb-3 uppercase">
        <h1 class="font-medium tracking-widest">DMCA</h1>
    </div>
    ...
    <div class="bg-primary-900 text-primary-400 rounded p-4">
        <div class="flex flex-col gap-6 text-md">
            ...
            <div class="flex flex-col gap-2">
                <p>
                    Perhatikan bahwa kami hanya akan menangani pesan yang memenuhi persyaratan berikut :
                </p>
                <div class="flex flex-wrap gap-1 pl-6">
                    <p>
                        1. Tolong beritahu kami nama, alamat, dan nomor telepon Anda.
                    </p>
                    <p>
                        2. Jelaskan materi berhak cipta mana yang terpengaruh.
                    </p>
                    <p>
                        3. Mohon berikan link url yang tepat dan lengkap.
                    </p>
                    <p>
                        4. Jika ada file ilegal, berikan penjelasan singkat dalam dua atau tiga poin jika itu terjadi.
                    </p>
                    <p>
                        5. Pastikan bahwa Anda dapat menerima pertanyaan lebih lanjut dari kami melalui email.
                    </p>
                    <p>
                        6. Harap menulis hanya dalam bahasa Inggris atau Indonesia.
                    </p>
                </div>
                <p class="flex flex-col">
                    ...
                    <span class="pl-6">
                        Pesan anonim atau tidak lengkap tidak akan ditangani. Terimakasih atas pengertiannya.
                    </span>
                </p>
            </div>
            <p>
