<section>
    ...
    <div class="bg-primary-900 rounded p-4 text-primary-400">
        <p class="text-lg font-medium tracking-widest mb-2">
            <?php echo $project_name ?>
            <span class="text-md"> - </span>
            <span class="text-primary-400"><?php echo $project_subname ?></span>
        </p>
        <div class="flex flex-col gap-6 text-md">
            <p>
                <?php echo $project_name ?> adalah platform baca komik yang berfokus pada kenyamanan pengguna dengan
                menawarkan pembacaan komik tanpa iklan yang mengganggu.
                Situs ini menggunakan data dari berbagai sumber melalui mirroring untuk memastikan pembaruan komik yang
                cepat dan lengkap, dan memiliki tampilan menarik, fitur handal, dan pembaruan konten yang konsisten.
                Meskipun mungkin ada kesamaan dengan situs lain, fokus <?php echo $project_name ?> adalah memberikan
