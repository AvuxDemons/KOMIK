                        ...
                        <div class="relative flex flex-1 flex-col p-3 bg-primary-900 rounded">
                            <a href="/komik/<?php echo $item['endpoint']; ?>" class="relative">
                                <div class="h-[250px] md:h-[210px] w-full overflow-hidden">
                                    <img src="<?php echo $item['thumbnail']; ?>" alt="..." loading="lazy" class="rounded transition hover:opacity-75 object-cover h-full w-full" placeholder="blur" blurDataURL="/assets/image/placeholder.webp">
                                </div>
                                <div class="absolute top-2 right-2 w-full max-w-[30px] mx-auto aspect-[3/2]">
                                    <img src="/public/assets/images/<?php echo $item['type']['country']; ?>.png" alt="..." class="rounded shadow">
                                </div>
                                <?php if ($item['type']['isColored']): ?>
                                                    <p class="absolute bottom-2 right-2 flex items-center gap-1 px-1 py-0.5 rounded bg-yellow-500 text-[10px] font-[600] text-primary-900">
                            ...
                            <div class="flex flex-col justify-between h-full gap-1 mt-2">
                                <a href="/komik/<?php echo $item['endpoint']; ?>" class="line-clamp-2 text-center text-sm font-[500] hover:text-primary-600 transition">
                                    <?php echo $item['title']; ?>
                                </a>
