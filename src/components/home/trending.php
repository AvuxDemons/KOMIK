...
<div class="flex flex-col">
    ...
    <div class="swiper-container mySwiper2 max-w-[1300px] overflow-hidden">
        <div class="swiper-wrapper">
            <?php foreach ($data as $id => $manga): ?>
                <div class="swiper-slide">
                    <div
                        class="relative flex flex-1 flex-col p-3 bg-primary-900 rounded h-full max-w-[190px] md:max-w-[210px]">
                        <a href="/komik/<?php echo $manga['endpoint']; ?>"
                            class="relative transition hover:opacity-75 transition">
                            <div class="h-[225px] md:h-[250px] w-full overflow-hidden">
                                <img src="<?php echo $manga['thumbnail']; ?>" alt="..." loading="lazy"
                                    class="rounded transition hover:opacity-75 object-cover h-full w-full"
                                    placeholder="blur" blurDataURL="/assets/image/placeholder.webp">
                            </div>
                            <div class="absolute top-2 right-2 w-full max-w-[30px] mx-auto aspect-[3/2]">
                                <img src="/public/assets/images/<?php echo $manga['type']['country']; ?>.png" alt="..."
                                    class="rounded shadow" />
                            </div>
                            <?php if ($manga['type']['isColored']): ?>
                                <p
                                    class="absolute bottom-2 right-2 flex items-center gap-1 px-1 py-0.5 rounded bg-yellow-500 text-[10px] font-[600] text-primary-100">
                                    <FaPalette /> WARNA
                                </p>
                            <?php endif; ?>
                        ...
                        <div class="flex flex-col justify-between h-full gap-1 mt-2">
                            ...
                            <div class="flex flex-row justify-between text-[0.85em] text-primary-600">
                                ...
                                <p class="flex flex-row gap-1 items-center">
                                    <span class="hidden md:block">Rating</span> <?php echo $manga['rating']; ?>
                                    <FaStar />
                                </p>
                            </div>
                        </div>
