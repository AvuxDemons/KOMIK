    ...
    <body class="bg-black">
        ...
        <div id="content" class="flex flex-col md:flex-row gap-4">
            <div class="flex flex-col gap-6 w-full md:max-w-[70%]">
                <?php include ('src/components/about/about.php'); ?>
                <?php include ('src/components/about/source.php'); ?>
                <?php include ('src/components/about/dmca.php'); ?>
                <?php include ('src/components/about/privacypolicy.php'); ?>
            </div>
